...
<template>
  <header class="bg-white dark:bg-gray-900">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="md:hidden" id="mobile-menu" v-show="mobileOpen">
        <nav aria-label="Mobile" class="px-4 pb-4">
          <ul
            class="flex flex-col gap-4 text-sm bg-white dark:bg-gray-900 p-4 rounded-md shadow-sm"
          >
            <li>
              <RouterLink
                to="about"
